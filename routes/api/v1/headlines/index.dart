...
/// Handles requests for the /api/v1/headlines collection endpoint.
...
/// Handles GET requests: Retrieves a collection of headlines.
...
/// Handles POST requests: Creates a new headline.
Future<Response> _handlePost(RequestContext context) async {
  ...
  Headline itemToCreate;
  try {
    itemToCreate = Headline.fromJson(requestBody);
