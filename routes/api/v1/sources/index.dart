...
/// Handles requests for the /api/v1/sources collection endpoint.
///
/// This endpoint supports GET for retrieving a list of sources and POST for
...
/// Handles GET requests: Retrieves a collection of sources.
///
...
/// Handles POST requests: Creates a new source.
///
...
Future<Response> _handlePost(RequestContext context) async {
  ...
  Source itemToCreate;
  try {
    itemToCreate = Source.fromJson(requestBody);
